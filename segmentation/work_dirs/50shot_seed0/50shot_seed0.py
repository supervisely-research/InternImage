...
log_level = 'INFO'
load_from = '/root/workspace/InternImage/upernet_internimage_h_896_160k_ade20k.pth'
resume_from = None
workflow = [('train', 1)]
...
optimizer_config = dict(
    grad_clip=dict(max_norm=0.1, norm_type=2), accumulative_counts=4)
lr_config = dict(
    policy='poly',
    warmup='linear',
    warmup_iters=1500,
...
data = dict(
    ...
    train=dict(
        type='TomatoDataset',
        data_root='/root/workspace/InternImage/data/train_50shot_seed0/',
...
optim_wrapper = dict(type='AmpOptimWrapper', dtype='float16')
work_dir = './work_dirs/50shot_seed0'
gpu_ids = [0]
auto_resume = False
